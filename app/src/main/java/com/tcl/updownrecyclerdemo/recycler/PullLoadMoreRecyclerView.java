...
import com.tcl.updownrecyclerdemo.recycler.RecyclerViewOnScroll;
import com.tcl.updownrecyclerdemo.recycler.SwipeRefreshLayoutOnRefresh;

/**
 * @author Liyang Sun
 * @Description:
 * @date 2016/8/15 14:25
 * @copyright HAWK
 */
...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private com.tcl.updownrecyclerdemo.recycler.PullLoadMoreRecyclerView.PullLoadMoreListener mPullLoadMoreListener;
    ...
    private com.tcl.updownrecyclerdemo.recycler.PullLoadMoreRecyclerView.AdapterDataObserver mEmptyDataObserver;
    ...
    private void initView(Context context) {
        ...
        mRecyclerView.setOnTouchListener(new com.tcl.updownrecyclerdemo.recycler.PullLoadMoreRecyclerView.onTouchRecyclerView());
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        if (adapter != null) {
            ...
            if (mEmptyDataObserver == null) {
                mEmptyDataObserver = new com.tcl.updownrecyclerdemo.recycler.PullLoadMoreRecyclerView.AdapterDataObserver();
            }
    ...
    public void setOnPullLoadMoreListener(com.tcl.updownrecyclerdemo.recycler.PullLoadMoreRecyclerView.PullLoadMoreListener listener) {
