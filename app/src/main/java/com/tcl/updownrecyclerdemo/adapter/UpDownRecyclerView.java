 ...
 * @author Liyang Sun
 * @Description:
 * @date 2016/8/15 10:35
 * @copyright HAWK
 */

public class UpDownRecyclerView extends PullLoadMoreRecyclerView {
    private RecyclerView mRecyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private UpDownRecyclerView.PullLoadMoreListener mPullLoadMoreListener;
    ...
    private UpDownRecyclerView.AdapterDataObserver mEmptyDataObserver;

    public UpDownRecyclerView(Context context) {
        super(context);
        initView(context);
    }

    public UpDownRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        mRecyclerView.setOnTouchListener(new UpDownRecyclerView.onTouchRecyclerView());
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        if (adapter != null) {
            ...
            if (mEmptyDataObserver == null) {
                mEmptyDataObserver = new UpDownRecyclerView.AdapterDataObserver();
            }
...
//                .start();
    ...
    public void setOnPullLoadMoreListener(UpDownRecyclerView.PullLoadMoreListener listener) {
